...
all: bin/main bin/spy_simulation bin/timer bin/monitor bin/citizen_manager bin/enemy_spy_network bin/enemy_country
...
src/enemy_country/spies.o : src/enemy_country/enemy_country.c 
	$(CC) $(CPPFLAGS) $(CFLAGS) $< -o $@ -c
